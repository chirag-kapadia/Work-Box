                        ...
                        <form class="form-horizontal">
                            <div class="col-md-4 no-padd">
                                <div class="input-group">
                                    <input type="text" class="form-control right-bor" id="joblist" placeholder="Skills, Designations, Companies"> </div>
                            </div>
                            <div class="col-md-3 no-padd">
                                <div class="input-group">
                                    <input type="text" class="form-control right-bor" id="location" placeholder="Search By Location.."> </div>
                            </div>
                            <div class="col-md-3 no-padd">
                                <div class="input-group">
            ...
            <div class="company-brand">
                <div class="container">
                    <div id="company-brands" class="owl-carousel">
                        <div class="brand-img"><img src="assets\img\microsoft-home.png" class="img-responsive" alt=""></div>
                        <div class="brand-img"><img src="assets\img\img-home.png" class="img-responsive" alt=""></div>
                        <div class="brand-img"><img src="assets\img\mothercare-home.png" class="img-responsive" alt=""></div>
