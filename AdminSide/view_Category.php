      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <!-- Write Here -->
            ...
            $Category_Exe=mysqli_query($con,$select_Category) or die(mysqli_error());
            while($Category_Details=mysqli_fetch_array($Category_Exe))
            {
          ?>
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                ...
                                <figcaption>
                                    <h4><?php echo $Category_Details['CategoryName']?></h4>
